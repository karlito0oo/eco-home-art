      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="mb-6">
              <img src="/eco-logo.png" alt="Eco Home Art Logo" className="h-12 w-auto" />
            </div>
            <p className="text-sm leading-relaxed">
              Alpha Distinct Development Solutions Inc specializes in eco-friendly furniture and home solutions.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-start space-x-3">
                ...
                <span>info.alphaddsi@gmail.com</span>
              </li>
              <li className="flex items-start space-x-3">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span>17 Valencia St., Susana Heights Subd., Tunasan Muntinlupa City, Philippines 1774</span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-green-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm">
              © {new Date().getFullYear()} Alpha Distinct Development Solutions Inc. All rights reserved.
            </p>
